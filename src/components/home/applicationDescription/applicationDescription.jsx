      ...
      <ul className="container px-5 pt-24 mx-auto flex flex-wrap">
        {block.items.map((item, index) => (
          <li key={index} className="flex relative pt-10 pb-20 sm:items-center md:w-2/3 mx-auto">
            ...
            <div className="flex-shrink-0 w-6 h-6 rounded-full mt-10 sm:mt-0 inline-flex items-center justify-center bg-primary text-white relative z-10 title-font font-medium text-sm"></div>
